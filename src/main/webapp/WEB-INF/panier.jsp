                    ...
                    <tr>
                        ...
                        <td>
                            <form action="panier" method="post" style="display:inline;">
                                <input type="hidden" name="id" value="${ligne.vinyle.id}" />
                        ...
                        <td><fmt:formatNumber value="${ligne.vinyle.prixVinyle}" type="currency" /></td>
                        <td><fmt:formatNumber value="${ligne.sousTotal}" type="currency" /></td>
